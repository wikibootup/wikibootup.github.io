...
# Epilogue
어쩌면 일상의 악이란 섬세함과 깊이의 부재에서 비롯되는 것인지도 모른다. 그것은 슬프지만 내 안에도 있고, 당신 안에도 있는 것이다. 그것은 생각보다 가까운 곳에, 예상치 못한 곳에, 그러나 만연해 있다. 그저 조금 더 섬세하고 깊어지는 수 밖에. 그리고 최근에는 직접 그 모습을 드러내는 악의 배후에 또 다른 무언가가 있다는 것을 알게 되었다. 서로 물고 뜯는 이 난장판의 배후에서 온화한 미소를 띄고있는 그림자가 보이려고 한다.
